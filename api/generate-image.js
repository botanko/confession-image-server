...
export default async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    try {
      ...
      const imageBuffer = await generateConfessionImageWithCanvas(confessionText, timestamp);
...
async function generateConfessionImageWithCanvas(confessionText, timestamp) {
